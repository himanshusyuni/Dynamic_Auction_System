    ...
    return (
        <div className="p-6 max-w-4xl mx-auto shadow-2xl rounded-lg">
            ...
            <p>
                ...
                page shall mean <strong>Himanshu Syuni</strong>, whose registered/operational office is <strong> Mehrauli, New Delhi</strong>.
            ...
            <ul className="list-disc ml-6">
                ...
                <li>You acknowledge that such information and materials may contain inaccuracies or errors,
                    and we expressly exclude liability for any such inaccuracies or errors to the fullest extent
                    permitted by law.</li>
            </ul>
            
            <h2 className="text-xl font-semibold mt-4">Liability</h2>
            <p>
                Your use of any information or materials on our website and/or product pages is entirely at your
            ...
            <p>
                Our website contains material which is owned by or licensed to us. This material includes, but is
            ...
            <p>
                ...
                for your convenience to provide further information. We do not endorse these websites and are
                not responsible for their content.
            </p>
            
            <h2 className="text-xl font-semibold mt-4">Legal Compliance</h2>
            <p>
                Any dispute arising out of the use of our website and/or purchase with us and/or any engagement
